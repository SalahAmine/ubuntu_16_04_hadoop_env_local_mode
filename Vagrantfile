...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define :hadaooplocal do |hadaooplocal|
    hadaooplocal.vm.box = "bento/ubuntu-16.04"
    hadaooplocal.vm.box_version = "201808.24.0"
    # hadaooplocal.vm.network :private_network, ip: "10.0.0.20"
    ...
    hadaooplocal.vm.network "forwarded_port", guest: 22, host: 2223, id: "ssh"
    hadaooplocal.vm.hostname = "hadaooplocal"
    # hadaooplocal.vm.provision "shell", path: "provision_machine.sh"
    ...
    hadaooplocal.vm.provision "ansible_local" do |ansible|
    ...
    hadaooplocal.vm.provider :virtualbox do |vb|
      vb.name = "hadaooplocal"
      vb.memory = 4096
      vb.cpus = 2
    end
  end
